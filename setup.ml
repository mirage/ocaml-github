...
(* OASIS_START *)
(* DO NOT EDIT (digest: 06357e14020b38b7ebab237b2e46a72d) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "build the js_of_ocaml xmlHttpRequest based subpackage";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Github_s"; "Github_core"; "Github_j"; "Github_t"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Github"; "Github_cookie_jar"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "github_core";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "GitHub API documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "create_release.ml"});
               Executable
                 ({
                     cs_name = "git-sync-releases";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "sync_releases.ml"});
               Executable
                 ({
                     cs_name = "git-upload-release";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "upload_release.ml"});
               Executable
                 ({
                     cs_name = "git-list-releases";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "list_releases.ml"});
               Executable
                 ({
                     cs_name = "git-list-events";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "list_events.ml"});
               Executable
                 ({
                     cs_name = "git-list-issues";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "list_issues.ml"});
               Executable
                 ({
                     cs_name = "git-search";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "search.ml"});
               Executable
                 ({
                     cs_name = "listen_events";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "listen_events.ml"});
               Executable
                 ({
                     cs_name = "git-gist";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "gist.ml"});
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "formac.ml"});
               Executable
                 ({
                     cs_name = "list_tags";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "releases.ml"});
               Executable
                 ({
                     cs_name = "deploy_keys";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "deploy_keys.ml"});
               Executable
                 ({
                     cs_name = "list_pulls";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "organizations.ml"});
               Executable
                 ({
                     cs_name = "parse_events";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "parse_events.ml"});
               Executable
                 ({
                     cs_name = "list_contributors";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "contributors.ml"});
               Executable
                 ({
                     cs_name = "test_javascript";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "js", OASISExpr.EFlag "tests"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "lib_test";
                   ...
                   {exec_custom = true; exec_main_is = "test_javascript.ml"})
            ];
          ...
          conf_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("sh", ["./init_config.sh"])))
                 ]
            };
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\136n\193\189\148\002\251/l\135\1673n\141\179\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
