...
(* OASIS_START *)
(* DO NOT EDIT (digest: afb8d0057637fc5a689108531661d8a5) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_datas.ml"});
               Executable
                 ({
                     cs_name = "list_pulls";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\026t\1440E\007,\156\175\182\176:4\169\229\230";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
