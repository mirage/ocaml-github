...
(* OASIS_START *)
(* DO NOT EDIT (digest: e0c62b2c217f1da411cd0d6a91268580) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cohttp.lwt_client", None);
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cohttp.lwt_server", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "¯ÜÁüÛw\005\154¼\137³ïbé\006\020";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
